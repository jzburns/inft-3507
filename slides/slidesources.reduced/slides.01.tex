...
\begin{frame}{Alternative approach}
  ...
  \end{itemize}
\end{frame}
%   \begin{frame}{Some common misconceptions}
...
\begin{frame}{Perspectives on distributed systems}
...
\begin{frame}{Distribution transparency}
  ...
  \end{block}
\end{frame}
% \begin{frame}{Degree of transparency}
...
\begin{frame}{Availability v Reliability: Numerical Example}
  ...
  \end{itemize}
  Same availability. Completely different reliability.
\end{frame}

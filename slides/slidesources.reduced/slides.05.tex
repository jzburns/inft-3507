...
%     cluster membership, anti-entropy repairs, rumor mongering for 
%     CRDT updates, and lightweight broadcast instead of heavy 
%     consensus protocols like Paxos or Raft when strong consistency 
%     isnt required.
%   \end{enumerate}
% \end{slide}
